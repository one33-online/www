  ...
  return (
    <div className="concept-b">
      ...
      <section
        ...
        id="why-we-exist"
      >
        <AnimateIn className="cb-why__inner" stagger>
      ...
      <section
        ...
        id="what-we-do"
      >
        <AnimateIn className="cb-what__inner" stagger>
          ...
          <div className="cb-what__panel">
            ...
            <p className="cb-what__panel-body">
              The relational work we do directly. We put trained people in rooms
              with communities and hold the difficult conversations that
              institutions can't, or won't. We show up consistently, long enough
              to be trusted.
            </p>
            <p className="cb-what__panel-detail">Direct. Sustained. Present.</p>
          </div>
          <div className="cb-what__panel">
            <p className="cb-what__panel-label">Practical</p>
            <p className="cb-what__panel-body">
              The practical work we facilitate. We connect organisations,
              government, skills, and communities to enable actual restoration.
              We don't execute it — we make it possible.
            </p>
      ...
      <section
        ...
        id="partner"
      >
        <AnimateIn className="cb-partner__inner" stagger>
      ...
      <section
        ...
        id="stories"
      >
        <AnimateIn className="cb-stories__inner" stagger>
