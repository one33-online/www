  ...
  return (
    <div className={cn("concept-d", cormorantGaramond.variable)}>
      ...
      >
        ...
        <AnimateIn className="cd-method__inner" stagger>
          ...
          <div className="cd-method__grid">
            ...
            <div className="cd-method__col">
              ...
              <p className="cd-method__col-body">
                ...
                into rooms with communities — across race, gender, culture, and
                generation. We show up consistently, long enough to be trusted.
                This work, we do ourselves.
              </p>
            ...
            <div className="cd-method__col">
              ...
              <span aria-hidden="true" className="cd-method__rule" />
              <p className="cd-method__col-body">
                We identify what has been lost — then connect the organisations,
                government resources, and skills equipped to restore it. One33
                does not build. It positions the people who do, in the places
      ...
      <section aria-label="One33 method" className="cd-quote">
        <div aria-hidden="true" className="cd-divider cd-divider--light" />
        <AnimateIn className="cd-quote__inner" stagger>
      ...
      >
        <div aria-hidden="true" className="cd-divider" />
        <AnimateIn className="cd-partner__inner" stagger>
          ...
          <div className="cd-partner__cards">
            ...
            <article className="cd-card">
              ...
              <p className="cd-card__body">
                Reconciliation takes time. Partnership allows us to stay present
                in communities — not arrive with a one-off solution and leave.
                Your giving funds ongoing presence.
              </p>
            ...
            <article className="cd-card">
              ...
              <p className="cd-card__body">
                ...
                restore — legal, medical, trade, entrepreneurial. If you carry a
                skill set, there is likely a place for it here.
              </p>
      ...
      <section aria-label="Legal documentation" className="cd-docs">
        <AnimateIn className="cd-docs__inner" stagger>
      ...
      <section aria-labelledby="cd-give-heading" className="cd-give" id="give">
        <div aria-hidden="true" className="cd-divider" />
        <AnimateIn className="cd-give__inner" stagger>
          <span className="cd-kicker" id="cd-give-heading">
            Give
          </span>
          <h2 className="cd-give__heading">
            If you believe this <strong>matters</strong>, this is how it moves.
          </h2>
